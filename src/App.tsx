...
import { Routes, Route } from "react-router-dom"; // Se quitó BrowserRouter
import Index from "./pages/Index";
import { LoadingScreen } from "./components/LoadingScreen";
import { TooltipProvider } from "./components/ui/tooltip"; // Ruta relativa segura
    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <div className={`h-screen w-screen overflow-hidden transition-opacity duration-700 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
          {/* Suspense maneja la carga de componentes perezosos */}
